            ...
            <Row>
              <Col md={4} xs={12}>
                <div style={{ display: 'block' }}>
                  ...
                  <h4 className='text-center'>Applied Scientist @ Amazon Web Services</h4>
              ...
              <Col md={8} xs={12}>
                ...
                <p className='lead'>
                  ...
                  <a href='https://aws.amazon.com/' target='_blank' rel='noopener noreferrer'>
                    AWS
                  </a>. I am interested in various research areas in ML, including applications of natural language processing (NLP), generative models (e.g. VAE and GANs), graph neural networks (GNN), contrastive learning and reinforcement learning (RL). I have over 10 years of experience in life sciences and healthcare. In the past, I worked on developing ML methods leveraging biomedical data, ranging from multi-omics to longitudinal electronic health records (EHR), for drug discovery and modeling human diseases.
                </p>
                <p className='lead'>
